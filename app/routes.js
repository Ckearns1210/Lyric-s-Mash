...
app.get('/lyric/:search', function(req,res){
   ...
   request("http://api.musixmatch.com/ws/1.1/track.search?f_has_lyrics=1&page=1&page_size=1000&q_lyrics="+ encodeURI(req.params.search) +"&s_track_rating=desc&apikey=032f5b65b1a0deac1f5f44afc9d548c0", function (error, response, body) {
